    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: scrolled ? "0 4px 20px rgba(0,0,0,0.12)" : "0 2px 8px rgba(0,0,0,0.1)",
      ...
      >
        ...
        <div className="flex-1 flex items-center gap-2.5 p-2.5 max-sm:flex-col max-sm:items-center max-sm:text-center">
          ...
          <div className="flex flex-col items-start max-sm:items-center">
            <span className="text-sm text-gray-500">{t("establishedYear") ? `ESTD : ${t("establishedYear")}` : ""}</span>
            <span
        ...
        <div className="flex justify-between max-w-[1200px] mx-auto px-5">
          <ul className="hidden lg:flex list-none flex-1 m-0 p-0">
            {NAV_ITEMS.map((item) => (
              <li
                key={item.path}
                className="inline-block mr-7 relative"
              >
                <Link
                  href={item.path}
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-base font-semibold text-white">{t("schoolName")}</span>
              </div>
            </div>
            <button
          ...
          <ul className="list-none m-0 py-5 px-0 max-w-[400px] mx-auto">
            {NAV_ITEMS.map((item) => (
              <li key={item.path} className="mx-4 my-2 rounded-xl overflow-hidden shadow-sm bg-white">
                <Link
                  href={item.path}
                  onClick={() => setMobileMenuOpen(false)}
                  ...
                  style={
                    isActive(item.path)
                      ? { background: "linear-gradient(135deg, #10b981 0%, #059669 100%)", transform: "translateX(8px)", boxShadow: "0 4px 16px rgba(16,185,129,0.4)" }
                      : {}
                  }
                  onMouseEnter={e => {
