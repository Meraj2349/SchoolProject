          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 mb-6">
            {[
              ...
              >
                ...
                <span className="block mt-1.5 text-[0.82rem] font-semibold uppercase tracking-[0.04em] text-gray-500">
                  {card.label}
                </span>
              </div>
            ))}
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr>
                      {[t("student"), t("date"), t("status")].map((h) => (
                        <th
                          key={h}
                          className="px-4.5 py-3.5 text-left text-[0.82rem] font-bold uppercase tracking-[0.06em]"
                          style={{
                            padding: "14px 18px",
                            background: NAVY,
                            color: GOLD_LIGHT,
                  ...
                  <tbody>
                    {results.map((r, i) => (
                      ...
                      >
                        <td
                          className="px-4.5 py-3.5 text-[0.93rem]"
