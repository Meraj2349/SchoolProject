      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 leading-tight">{t("title")}</h2>
            <p className="text-lg text-gray-500 max-w-[600px] mx-auto leading-relaxed">{t("subtitle")}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 items-start mt-8">
            ...
            <div className="py-4">
              <p className="text-lg leading-relaxed text-gray-500 mb-6 text-justify">{t("body1")}</p>
              <p className="text-lg leading-relaxed text-gray-500 text-justify">{t("body2")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12 flex flex-col items-center gap-4">
            ...
            <h2 className="text-4xl font-bold text-gray-900 m-0">{t("visitTitle")}</h2>
            <p className="text-lg text-gray-500 max-w-[600px] mx-auto leading-relaxed">{t("locationSubtitle")}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-8 mt-8">
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg border border-gray-200">
              <h3 className="text-blue-600 text-2xl font-bold mb-6">{t("getInTouch")}</h3>
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={i} className="py-3 border-b border-gray-200 last:border-0">
                    <strong className="text-gray-900 block mb-1 text-sm font-semibold">{item.label}:</strong>
                    <p className="text-gray-500 m-0 text-[0.95rem] leading-relaxed">{item.value}</p>
                  </div>
                ))}
              </div>
            </div>
