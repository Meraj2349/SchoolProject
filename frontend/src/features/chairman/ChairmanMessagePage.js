    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div style={heroStyle}>
          ...
          />
          <Skeleton
            style={{ height: 44, width: "44%", margin: "0 auto 16px" }}
          />
        ...
        <div style={heroStyle}>
          ...
          <div className="relative z-[1]">
            <div className="inline-flex items-center gap-3.5 mb-4">
              ...
              />
              <span className="text-[.8rem]" style={{ color: GOLD }}>
                ★
              </span>
              <span
                className="block w-14 h-px"
            ...
            <h1
              className="m-0 mb-2.5 font-extrabold leading-tight"
              style={{
            ...
            <p
              className="m-0 mb-6 text-[.95rem] max-w-[480px] mx-auto leading-relaxed"
              style={{ color: "rgba(226,192,122,.65)" }}
            >
              {institution}
            </p>
            <div className="inline-flex items-center gap-2.5">
              ...
              />
              <span className="text-[.5rem]" style={{ color: GOLD }}>
                ◆
              </span>
              <span
                className="block w-10 h-px"
        ...
        <div className="max-w-[940px] mx-auto px-6">
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 2px 8px rgba(13,31,60,.07), 0 12px 36px rgba(13,31,60,.08)",
            }}
          >
            {/* Photo panel */}
            <div
            ...
            >
              ...
              {/* Corner ornaments */}
              <span
                className="absolute top-3 left-3 text-[.45rem] leading-none"
                style={{ color: "rgba(201,168,76,.5)" }}
              >
                ◆
              </span>
              <span
                className="absolute top-3 right-3 text-[.45rem] leading-none"
                style={{ color: "rgba(201,168,76,.5)" }}
              >
                ◆
              </span>
              <span
                className="absolute bottom-3 left-3 text-[.45rem] leading-none"
                style={{ color: "rgba(201,168,76,.5)" }}
              >
                ◆
              </span>
              <span
                className="absolute bottom-3 right-3 text-[.45rem] leading-none"
                style={{ color: "rgba(201,168,76,.5)" }}
              >
                ◆
              </span>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 0 6px rgba(201,168,76,.12), 0 8px 28px rgba(0,0,0,.35)",
                }}
              >
                {photoUrl ? (
                  <img
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${NAVY2}, #1e3a5f)`,
                    }}
                  >
                    👤
                  </div>
            ...
            {/* Info panel */}
            <div
              className="flex-1 p-9 flex flex-col justify-center"
              style={{ background: CREAM }}
            >
              <h2
                className="text-[1.7rem] font-extrabold m-0 mb-2 leading-tight"
                style={{ color: NAVY, letterSpacing: "-.01em" }}
              >
                {name}
              </h2>
              <div className="flex items-center gap-2.5 mb-1.5">
                ...
                />
                <span
                  className="text-[.8rem] font-bold tracking-[.14em] uppercase"
                  style={{ color: GOLD }}
                >
                  {title}
                </span>
              ...
              <p
                className="text-[.88rem] italic m-0 mb-6 leading-relaxed"
                style={{ color: MUTED }}
              >
                {institution}
              </p>
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-[.45rem]" style={{ color: GOLD }}>
                  ◆
                </span>
              </div>
            </div>
          ...
          >
            ...
            <div className="p-11 md:p-[44px_48px]">
              {/* Message body */}
              <div
                className="relative pl-7 border-l-[3px] mb-11"
              ...
              >
                ...
                <p
                  className="text-base leading-[1.9] m-0 text-justify whitespace-pre-wrap"
                  style={{ color: "#1a1a2e" }}
                >
                  {message}
                </p>
              ...
              <div
                className="pt-8"
                style={{ borderTop: "1px solid rgba(201,168,76,.2)" }}
              >
                ...
                <p
                  className="text-[.82rem] italic m-0 mb-1.5"
                  style={{ color: MUTED }}
                >
                  {t("bestRegards")}
                </p>
                <p
                  className="text-[1.05rem] font-extrabold m-0 mb-1"
                  style={{ color: NAVY }}
                >
                  {name}
                </p>
                <p
                  className="text-[.76rem] font-bold tracking-[.12em] uppercase m-0 mb-1"
                  style={{ color: GOLD }}
                >
                  {title}
                </p>
                <p
                  className="text-[.82rem] italic m-0"
                  style={{ color: MUTED }}
                >
                  {institution}
                </p>
          ...
          <div className="text-center mt-10 mb-4">
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.querySelector(".btn-fill").style.opacity = "1";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.color = GOLD2;
                e.currentTarget.querySelector(".btn-fill").style.opacity = "0";
              }}
              onClick={() => window.history.back()}
            >
              <span
                className="btn-fill absolute inset-0 transition-opacity duration-[220ms]"
                style={{
