...
export default function RoutinePage() {
  ...
  const selectCls =
    "px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-50 text-sm transition-all duration-300 focus:outline-none focus:border-emerald-500 focus:bg-white";
  const paginBtnCls =
    "px-5 py-3 bg-white text-gray-700 border-2 border-gray-200 rounded-lg cursor-pointer font-medium transition-all duration-300 hover:border-emerald-500 hover:text-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 font-sans">
      ...
      {/* Hero */}
      <section
        className="relative overflow-hidden py-16 pb-10 text-white"
        style={greenGrad}
      >
        <div className="max-w-[1200px] mx-auto px-5 relative z-[2]">
          <div className="max-w-[600px] mx-auto text-center">
            ...
            {currentBranchId != null && (
              <div
                className="inline-flex items-center gap-1.5 mt-2.5 px-3.5 py-1.5 rounded-2xl text-xs font-semibold text-green-900"
                style={{
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          {isError && (
            <div className="bg-red-50 text-red-800 p-5 rounded-xl text-center mb-8 border border-red-200">
              ...
              <button
                onClick={refetch}
                className="mt-2 px-4 py-2 bg-red-700 text-white border-none rounded-lg cursor-pointer font-medium"
              >
                {t("tryAgain")}
              </button>
            </div>
          ...
          {paged.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="mb-5">
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <h3 className="text-[1.25rem] font-bold text-gray-900 m-0 leading-snug flex-1">
                          {r.RoutineTitle}
                        </h3>
                        {r.FileURL && isPDF(r.FileType, r.FileURL) && (
                          <span className="px-2 py-1 rounded-md text-[10px] font-semibold uppercase tracking-wide bg-yellow-100 text-yellow-800 flex-shrink-0">
                            PDF
                          </span>
                        )}
                        {r.FileURL && isImage(r.FileType, r.FileURL) && (
                          <span className="px-2 py-1 rounded-md text-[10px] font-semibold uppercase tracking-wide bg-blue-100 text-blue-700 flex-shrink-0">
                            IMG
                          </span>
                        )}
                      </div>
            ...
            !isError && (
              <div className="text-center py-16 text-gray-500">
                ...
                <h3 className="text-2xl text-gray-700 m-0 mb-3">
                  {t("noRoutinesFound")}
                </h3>
